...
public sealed class EventsModel : PageModel
{
    ...
    private static readonly OperationAccentStyles[] OperationAccentPalette =
    {
        new(
            ...
            BadgeClass: "border border-sky-500/25 bg-sky-500/15 text-sky-100/95 ring-1 ring-inset ring-sky-400/40 shadow-[0_12px_30px_-18px_rgba(14,165,233,0.32)]",
        ...
        new(
            ...
            BadgeClass: "border border-fuchsia-500/25 bg-fuchsia-500/15 text-fuchsia-100/95 ring-1 ring-inset ring-fuchsia-400/40 shadow-[0_12px_30px_-18px_rgba(217,70,239,0.3)]",
        ...
        new(
            ...
            BadgeClass: "border border-emerald-500/25 bg-emerald-500/14 text-emerald-100/95 ring-1 ring-inset ring-emerald-400/40 shadow-[0_12px_30px_-18px_rgba(16,185,129,0.28)]",
        ...
        new(
            ...
            BadgeClass: "border border-amber-500/25 bg-amber-500/16 text-amber-100/95 ring-1 ring-inset ring-amber-400/40 shadow-[0_12px_30px_-18px_rgba(245,158,11,0.26)]",
        ...
        new(
            ...
            BadgeClass: "border border-rose-500/25 bg-rose-500/15 text-rose-100/95 ring-1 ring-inset ring-rose-400/40 shadow-[0_12px_30px_-18px_rgba(244,63,94,0.28)]",
